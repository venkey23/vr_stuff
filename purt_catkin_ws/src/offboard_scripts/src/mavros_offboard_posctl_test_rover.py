...
class Controller:
    ...
    def __init__(self):
        ...
        self.waypointsx          = [2,0,0,0] # Waypoints
        self.waypointsy          = [0,2,0,0] # Waypoints
    ...
    def updateSp(self):
        ...
        if (abs(self.local_pos.x-self.sp.pose.position.x)<.1 and abs(self.local_pos.y-self.sp.pose.position.y)<.1):
