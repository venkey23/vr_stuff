...
class MavrosOffboardPosctlTest(object):
    ...
    def __init__(self):
        ...
        self.rover_position = PoseStamped()
        self.state = State()
        self.mav_type = None
        ...
        self.qualisys_sub = rospy.Subscriber('/qualisys/quad/pose',
                                              PoseStamped,
                                              self.qualisys_callback)
	self.qualisys_sub_rover = rospy.Subscriber('/qualisys/rover/pose',
                                              PoseStamped,
                                              self.qualisys_callback)
    ...
    def test_posctl(self):
        ...
        # ENU
        positions = [(0, 0, 0),(5, 0, 0),(0, 0, 0), (5, 0, 0)]# ROVER
