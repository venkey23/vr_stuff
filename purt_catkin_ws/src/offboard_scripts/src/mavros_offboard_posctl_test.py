...
class MavrosOffboardPosctlTest(object):
    ...
    def __init__(self):
        ...
        self.qualisys_sub = rospy.Subscriber('/qualisys/hex/pose',
                                              PoseStamped,
    ...
    def test_posctl(self):
        ...
        # ENU
        positions = [(0, 0, 0.5), (0, 0, 3.5), (0, 0, 3.5), (0, 0, -0.05)]# ROVER
        #positions = [(0, 0, 1.6), (-8, 0, 1.6), (-8, 0, 0)]#, (0, 0, -0.05)] #Cruise
        #positions = [(0, 0, 0.5), (0, 0, 1.60), (0, 0, 1.60), (0, 0, 1.60), (0, 0, 1.60), (0, 0, -0.05)] # HOVER
